...
class TestConnectDiscoveryInfoView(TestCase):
    ...
    def test_get_backchannel_logout_support_info_when_enabled(self):
        ...
        # Ensure the discovery document explicitly advertises backchannel logout support
        self.assertIn("backchannel_logout_supported", response_data)
        self.assertIs(response_data["backchannel_logout_supported"], True)
